...
![Blazorized_walkthrough_image_1.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_1.png)
...
![Blazorized_walkthrough_image_2.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_2.png)
...
![Blazorized_walkthrough_image_3.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_3.png)
...
![Blazorized_walkthrough_image_4.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_4.png)
...
![Blazorized_walkthrough_image_5.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_5.png)
...
![Blazorized_walkthrough_image_6.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_6.png)

This JWT secret key is the same one used by `api.blazorized.htb`:

![Blazorized_walkthrough_image_7.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_7.png)

The API validates a JWT based on certain validation parameters:

![Blazorized_walkthrough_image_8.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_8.png)
...
![Blazorized_walkthrough_image_9.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_9.png)

While on the `Blazor Server` app, the developer uses the `GenerateSuperAdminJWT` function when the admin signs in:

![Blazorized_walkthrough_image_10.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_10.png)
...
![Blazorized_walkthrough_image_11.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_11.png)

![Blazorized_walkthrough_image_12.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_12.png)
...
![Blazorized_walkthrough_image_17.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_17.png)

![Blazorized_walkthrough_image_18.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_18.png)

Notice that the footer says the web application is built with `Blazor WebAssembly`:

![Blazorized_walkthrough_image_19.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_19.png)

Notice that pages with the `/post/{GUID}` routes fail to fetch data from the API:

![Blazorized_walkthrough_image_20.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_20.png)

Inspect the request to find a new `api.blazorized.htb` subdomain:

![Blazorized_walkthrough_image_21.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_21.png)

Add it to `/etc/hosts` and try again:

![Blazorized_walkthrough_image_22.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_22.png)

Explore the Swagger UI over `api.blazorized.htb/swagger/index.html`:

![Blazorized_walkthrough_image_23.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_23.png)
...
![Blazorized_walkthrough_image_24.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_24.png)
...
![Blazorized_walkthrough_image_25.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_25.png)
...
![Blazorized_walkthrough_image_26.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_26.png)
...
![Blazorized_walkthrough_image_27.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_27.png)

Click the `Check for Updates` button and inspect the requests to `posts` and `categories` to notice that they contain a JWT:

![Blazorized_walkthrough_image_28.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_28.png)

![Blazorized_walkthrough_image_29.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_29.png)

Paste the JWT into [jwt.io](https://jwt.io/):

![Blazorized_walkthrough_image_30.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_30.png)

Download the lazily loaded `Blazorized.Helpers.dll` for further analysis:

![Blazorized_walkthrough_image_31.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_31.png)

![Blazorized_walkthrough_image_32.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_32.png)
...
![Blazorized_walkthrough_image_33.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_33.png)

Inspect the `JWT` class to find the required parameters to create signed JWTs, including the claims of a `Super Admin`:

![Blazorized_walkthrough_image_34.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_34.png)
...
![Blazorized_walkthrough_image_35.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_35.png)
...
![Blazorized_walkthrough_image_36.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_36.png)
...
![Blazorized_walkthrough_image_37.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_37.png)

Check the `/check-duplicate-post-title`/`check-duplicate-category-name` routes/pages:

![Blazorized_walkthrough_image_38.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_38.png)

Try to inject SQL:

![Blazorized_walkthrough_image_39.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_39.png)
...
![Blazorized_walkthrough_image_40.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_40.png)

Land as `NU_1055` and notice that it _DOES NOT_ possess `SeImpersonatePrivilege` (no 🥔 for today):

![Blazorized_walkthrough_image_41.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_41.png)
...
![Blazorized_walkthrough_image_42.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_42.png)
...
![Blazorized_walkthrough_image_43.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_43.png)
...
![Blazorized_walkthrough_image_44.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_44.png)

Also notice that `SSA_6010` is a member of that group:

![Blazorized_walkthrough_image_45.png](DigitalGarden/HTB_Walkthroughs/Machines/Blazorized/assets/Blazorized_walkthrough_image_45.png)
